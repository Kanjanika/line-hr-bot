...
# การตั้งค่าระบบ
REPORT_TIME       = os.getenv("REPORT_TIME",       "09:45")  # เวลาส่ง daily report (HH:MM, Asia/Bangkok)
WORKPLAN_DEADLINE = os.getenv("WORKPLAN_DEADLINE", "09:30")  # deadline ตรวจแผนงาน + บันทึก Excel
